...
class EqualBreathing : AppCompatActivity() {
    ...
    // Equal Breathing 5 - 5
    private val phases = arrayOf("Tarik napas", "Hembuskan")
    private val durations = arrayOf(5, 5)
    ...
    private fun saveSessionAndGoToFeedback() {
        val session = hashMapOf(
            ...
            "exerciseType" to "equal_breathing",
            "pattern" to "5-5",
            "totalDuration" to 10,
